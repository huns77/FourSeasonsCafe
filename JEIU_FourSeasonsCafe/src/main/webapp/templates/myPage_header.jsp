    ...
    <nav class="navbar navbar-expand-lg sticky-top" id="main-navbar">
      <div class="container-fluid row justify-content-between">
        ...
        <div class="collapse navbar-collapse col-5" id="toggle-navigation">
         ...
         <%
            ...
            %>
                  <a href="./myPage.jsp" class="nav-link main-nav-unit">MYPAGE</a>
         <%   
                  }
	 ...
	 <div class="sessionss">
	    <div class="ul_bar">
	       <div><h3>마이페이지</h3></div>
	          <ul>
	             <li class="head_menu">쇼핑 정보</li>
	             <li><a href="./myPage_order.jsp">- 주문목록/배송조회</a></li>
	             <li><a href="../order_bocket.jsp">- 장바구니</a></li>
	          </ul>
	          <ul>
	             <li class="head_menu">회원정보</li>
	             <li><a href="./update_user.jsp">- 회원정보 수정</a></li>
	          </ul>
		   </div>
</body>
</html>